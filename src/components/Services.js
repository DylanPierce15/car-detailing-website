        ...
        <section className="services-section">
            ...
            <div className="services-container">
                <div className="service-card">
                    ...
                    <h4>Looking for an interior detailing service that will leave your car looking and feeling new? Our team offers 
                    a comprehensive package that includes vacuuming and a deep clean of your seats, console, dash, vents, steering wheel, etc.</h4>
                ...
                <div className="service-card">
                    ...
                    pressure wash, thorough hand wash, streak-free glass cleaning, thorough wheel cleaning, and spray wax for that extra shine that lasts for weeks.</h4>
                ...
                <div className="service-card">
                    ...
                    <h4>Looking for a detailing service that combines both interior and exterior cleaning services? Look no further!
                         Our team is here to provide you with top-notch detailing services that will leave your car looking and feeling brand new</h4>
